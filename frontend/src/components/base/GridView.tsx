...
import { formatDisplayValue, parseDurationInput, hexAlpha } from "@/lib/format";
    ...
    >
      {isLinkedRecord ? (
        (() => {
          ...
          const foreignTableId = (field.options_json as { foreignTableId?: string })?.foreignTableId;
          const single = !!(field.options_json as { prefersSingleRecordLink?: boolean })?.prefersSingleRecordLink;
              ...
              <div className="flex flex-wrap items-center gap-1 py-0.5">
                ...
                <button
                  onClick={(e) => {
                    ...
                    let x = r.left;
                    if (x + 368 > window.innerWidth - 8) x = Math.max(8, window.innerWidth - 368 - 8);
                    let y = r.bottom + 4;
                    if (y + 330 > window.innerHeight - 8) y = Math.max(8, r.top - 330 - 4);
              ...
              {linkedPickerPos && foreignTableId && (
                <LinkedRecordPicker
                  ...
                  onSelect={(newIds) => {
                    ...
                    if (single) setLinkedPickerPos(null);
                  }}
